<div class="bg-white shadow-md rounded my-6 overflow-hidden">
    <div class="p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-gray-50 border-b">
        ...
        <a href="/contacts/new" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded text-sm inline-flex items-center w-full sm:w-auto justify-center"><i class="fas fa-plus mr-2"></i>Novo Contato</a>
    </div>
        ...
        <?php if ($contacts): ?>
            <?php foreach ($contacts as $contact): ?>
                ...
                <tr class="hover:bg-gray-50">
                    <td data-label="Nome" class="px-4 py-4 border-b border-gray-200 font-semibold text-gray-900"><?= h($contact['name']) ?></td>
                    <td data-label="Celular" class="px-4 py-4 border-b border-gray-200"><?= h($contact['celular']) ?></td>
                    <td data-label="E-mail CAST" class="px-4 py-4 border-b border-gray-200 text-sm"><?= h($contact['email_cast']) ?></td>
                    <td data-label="E-mail Tereos" class="px-4 py-4 border-b border-gray-200 text-sm"><?= h($contact['email_tereos']) ?></td>
                    <td data-label="Escalação" class="table-full px-4 py-4 border-b border-gray-200 text-sm">
                        <?php if ($appNames): ?>
                    ...
                    <td class="table-actions px-4 py-4 border-b border-gray-200 whitespace-nowrap">
