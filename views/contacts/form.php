<?php $item = $contact ?? []; ?>
<div class="max-w-2xl mx-auto bg-white shadow-md rounded my-6">
    ...
    <form method="post" class="p-6 space-y-5">
        ...
        <div class="flex justify-end pt-4 gap-3">
            <a href="/contacts" class="px-4 py-2 rounded border border-gray-300 text-gray-700 text-sm hover:bg-gray-50">Cancelar</a>
